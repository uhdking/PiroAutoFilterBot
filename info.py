...
BOT_TOKEN = environ.get('BOT_TOKEN', '5654971594:AAEklfAeBfryBQllwTpura2QLYK0VZ7uuMQ')

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))
# Bot images & videos
PICS = (environ.get('PICS', 'https://te.legra.ph/file/76414bc391876745bc38b.jpg https://te.legra.ph/file/7389f3947952c8037b582.jpg')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5134179712 1925422909').split()]
...
AUTH_GROUPS = [-1001853687723]
support_chat_id = environ.get('SUPPORT_CHAT_ID')
reqst_channel = environ.get('REQST_CHANNEL_ID')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", "</b><u>🚨 Here Not Available !!</u> \n\n 🌟 If You Want Your Requested Movies or Web Series. ​​👇👇 \n\n 💎 UPGRADE TO PREMIUM PLAN \n 👉 https://t.me/ORGPrime/26 \n\n ✅ Contact ➠ @UHDSupport \n\n ❤️ Premium Channels \n 👉 @MoViesPremium \n 👉 @UHDPrimes \n 👉 @ORGPrime</b>"))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://movies:premium@uhdowner.h05edc3.mongodb.net/?retryWrites=true&w=majority")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001337373398')).split()]
